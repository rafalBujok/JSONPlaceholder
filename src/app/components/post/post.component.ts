...
import { getCommentsState } from './../../comments/comment.state';
...
import CommentState from 'src/app/comments/comment.state';
...
export class PostComponent implements OnInit {
  constructor(private commentStore: Store<{ Comments: CommentState }>,
  ...
  getComments() {
    ...
    this.commentStore.dispatch(CommentActions.BeginGetCommentAction({ payload: id }));
  }
  getPost() {
    const id: Id = { id: this.postId };
  ...
  postComment(val: Comment) {
    ...
    this.commentStore.dispatch(CommentActions.BeginCreateCommentAction({ payload: comment }));
  }
