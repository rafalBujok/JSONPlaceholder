...
const reducer = createReducer(
  ...
  on(CommentActions.CreateCommentAction, (state, comment) => {
    return { ...state, Comments: [...state.Comments, comment], CommentError: null };
  }),

  on(CommentActions.SuccessGetCommentAction, (state: CommentState, { payload }) => {
    return { ...state, Comments: payload };
  }),
  on(CommentActions.SuccessCreateCommentAction, (state: CommentState, { payload }) => {
    return { ...state, Comments: [...state.Comments, payload], CommentError: null };
  }),
