...
export const GetCommentAction = createAction('[Comment] - Get Comment', props<Id>());

export const BeginGetCommentAction = createAction('[Comment] - Begin Get Comment', props<{ payload: Id }>());
...
export const ErrorCommentAction = createAction('[Comment] - Error', props<Error>());
